...
- [Visual regressions](./visual-regression.md) — first-paint tokens, 18-route overflow sweep, borders/buttons/spacing, and nav prefetch. Required after first-paint or Lighthouse work.
