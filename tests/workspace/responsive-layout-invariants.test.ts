...
assert.match(appLayout, /addEventListener\("load"/);
...
assert.match(
  source("src/app/first-paint-css.ts"),
  /\[data-jobs-filters="true"\]\{height:7\.75rem;overflow:hidden;box-sizing:border-box;border:1px solid var\(--pf-border\)/,
);
