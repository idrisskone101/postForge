...
assert.match(request.prompt, /RAW iPhone aesthetic/i);
assert.match(request.prompt, /candid selfie/i);
...
assert.match(request.prompt, /minimal processing/i);
assert.match(request.prompt, /true-to-life detail/i);
assert.match(request.prompt, /natural window light/i);
assert.match(request.prompt, /warm sunlight/i);
assert.match(request.prompt, /shallow depth of field/i);
assert.match(request.prompt, /realistic background context/i);
