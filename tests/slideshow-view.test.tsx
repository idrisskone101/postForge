...
assert.match(previewSource, /data-slide-stage/);
assert.match(previewSource, /100cqw/);
assert.match(previewSource, /ResizeObserver/);
assert.match(previewSource, /\[container-type:inline-size\]/);
...
assert.match(editMarkup, /data-slide-stage=/);
assert.match(editMarkup, /scale\(calc\(100cqw \/ 1080px\)\)/);
