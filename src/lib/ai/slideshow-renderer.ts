...
export function createSlideshowTextOverlaySvg(
  ...
  const shadowFilter = style === "plain" || style === "outline" ? ' filter="url(#text-shadow)"' : "";
  ...
  return Buffer.from(`
    <svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
      <defs>
        <filter id="text-shadow" x="-30%" y="-30%" width="160%" height="170%" color-interpolation-filters="sRGB">
