Slideshow overlay fonts for Satori (TTF/OTF/WOFF only; Satori does not read WOFF2).
...
Sans, rounded, condensed, and Poppins map to Inter. Serif maps to Liberation Serif.
SerifItalic and Editorial map to italic Liberation Serif. Mono maps to Liberation Mono.
