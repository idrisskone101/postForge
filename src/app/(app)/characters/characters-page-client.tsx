    ...
    <div data-page-inset="true" className="px-5 py-5 sm:px-7 lg:px-8">
      ...
      {records.length === 0 ? (
        ...
        >
          ...
          <h2 data-empty-heading="true" data-empty-title="Create a reusable character"><span className="sr-only">Create a reusable character</span></h2>
          ...
          <Link href="/characters/new" data-empty-actions="true" className="pf-button-primary mt-5"><UserRoundPlus className="size-3.5" /> New character</Link>
