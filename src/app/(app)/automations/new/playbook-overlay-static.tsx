    ...
    >
      ...
      >
        ...
        <footer
          ...
          className="flex shrink-0 flex-col gap-3 border-t border-[var(--pf-border)] bg-[var(--pf-surface)] px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 sm:flex-row sm:items-center sm:justify-between sm:px-5"
        >
