...
import { getCloneStudioViewModel } from "@/app/(app)/ugc-clone/clone-view-model";
import type { useCloneIdentity } from "@/app/(app)/ugc-clone/use-clone-identity";
import type { useCloneRefImages } from "@/app/(app)/ugc-clone/use-clone-ref-images";
