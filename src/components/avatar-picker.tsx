...
export function buildAvatarCandidateGenerationRequest({
  ...
  return {
    ...
    prompt: [
      ...
      "Add soft sex appeal through confident eye contact, relaxed flirty expression, feminine posture, flattering crop, glossy lips, and warm approachable energy without making the pose explicit or oversexualized.",
      "Vary presentation with simple varied backgrounds and a varied wardrobe of cool and hip outfit choices such as fitted tanks, baby tees, ribbed camis, oversized button-ups, denim, athleisure, or casual Pinterest-style basics; avoid repeating the same white-cami look every time.",
      "Use a natural iPhone front-camera UGC look with casual available light, slight grain, phone compression, lower-fidelity selfie texture, subtle skin detail, and imperfect real-photo sharpness.",
